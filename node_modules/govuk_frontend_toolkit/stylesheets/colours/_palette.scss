...
$link-colour: 	#0000ee //was $govuk-blue;
$link-active-colour: 	#b9ff06 // was$light-blue;
$link-hover-colour: 	#b9ff06 // $light-blue;
$link-visited-colour: 	#551a8b // was #4c2c92;
$button-colour: #00823b;
$focus-colour: $yellow;
$text-colour: 	#004269 // was $black;             // Standard text colour
