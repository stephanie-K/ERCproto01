      ...
      <!--a href="{{ params.homepageUrl | default('/') }}" class="govuk-header__link govuk-header__link--homepage"-->
        <span class="govuk-header__logotype">
          ...
          >
           ...
           <a href="/index.html" id="logo-erc"><image src="{{ asset_path }}/public/images/ERC/erclogo.png" alt="East Renfrewshire Council Logo" width="188" height="90"></image></a>
