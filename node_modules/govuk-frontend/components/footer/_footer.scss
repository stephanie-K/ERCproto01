...
@include govuk-exports("govuk/component/footer") {
  ...
  $govuk-footer-background: white; // was $govuk-canvas-background-colour;
  $govuk-footer-border-top: #99baca; // was #a1acb2;
  $govuk-footer-border: #99baca; // was govuk-colour("grey-2");
  $govuk-footer-text :#345663; // #225369; // was #454a4c;
  $govuk-footer-link: white; // #345663; // #225369; // was $govuk-footer-text;
  $govuk-footer-link-hover: black ;// #2b8cc4; // was #171819;
  $govuk-footer-link-visited: white ;// #4c2c92; // was not here
  $erc-logo-blue: #0071BA;
  ...
  .govuk-footer {
   ...
   // @include govuk-responsive-padding(5, "bottom");
    ...
    background-color: $erc-logo-blue;
  }
  ...
  .govuk-footer__link {
    ...
    &:visited { // new was like just for link above
      color: $govuk-footer-link-visited;
    }
  ...
  .govuk-footer__section-break {
    margin: 20px 0; // Reset `<hr>` default margins
